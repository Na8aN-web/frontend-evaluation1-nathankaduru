            ...
            >
                <div className="w-full mx-auto">
                    ...
                    <div className="relative">
                        <h1 className="text-[4.4vw] flex items-start flex-wrap leading-[100%] -tracking-[0.1vw]">
                            <div className='inline-flex relative top-3 items-start justify-start mr-72'><span className="text-[1vw] leading-[130%] text-[#1d1d1d] tracking-wide">The studio</span></div>
                            ...
                            <button className="bg-[#1d1d1d] tracking-normal self-center justify-self-center text-white px-8 py-3 rounded-full text-sm  hover:bg-[#e5e5e5] hover:text-[#1d1d1d] cursor-pointer relative top-1 transition-colors duration-200">
                                Learn more
                            </button>
                        </h1>
